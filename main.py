...
# connected WebSockets keyed by username (allow multiple tabs per user)
clients: dict[str, set[WebSocket]] = {}   # username → {ws, ...}
...
async def websocket_endpoint(ws: WebSocket, token: str = Query(...)):
    ...
    # Immediate data push on connect
